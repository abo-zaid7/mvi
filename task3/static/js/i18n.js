...
const TRANSLATIONS = {
  ...
  en: {
    ...
    "a11y.viewerImage": "The scan with the segmentation drawn on it",
    ...
    "models.unavailable": "The files for this model are not on this machine yet.",
    "models.recorded": "recorded results",
    ...
    "views.scan.caption": "The scan with nothing drawn on it.",
    ...
    "settings.skin": "Interface design",
    "settings.skin.original": "Original",
    "settings.skin.clinical": "Clinical workstation",
    "settings.skin.aurora": "Aurora",
    "settings.skin.hint": "Three designs of the same interface. Every control, keyboard shortcut and result is identical in all three - only the look and the arrangement change.",
  ...
  ms: {
    ...
    "a11y.viewerImage": "Imbasan dengan segmentasi dilukis di atasnya",
    ...
    "models.unavailable": "Fail untuk model ini belum ada pada mesin ini.",
    "models.recorded": "keputusan yang dirakam",
    ...
    "views.scan.caption": "Imbasan tanpa apa-apa lukisan.",
    ...
    "settings.skin": "Reka bentuk antara muka",
    "settings.skin.original": "Asal",
    "settings.skin.clinical": "Stesen kerja klinikal",
    "settings.skin.aurora": "Aurora",
    "settings.skin.hint": "Tiga reka bentuk bagi antara muka yang sama. Setiap kawalan, pintasan papan kekunci dan keputusan adalah serupa dalam ketiga-tiganya - hanya rupa dan susun atur yang berubah.",
  ...
  ar: {
    ...
    "a11y.viewerImage": "الصورة مع التجزئة مرسومة عليها",
    ...
    "models.unavailable": "ملفات هذا النموذج غير موجودة على هذا الجهاز بعد.",
    "models.recorded": "نتائج مسجّلة",
    ...
    "views.scan.caption": "الصورة دون أي رسم عليها.",
    ...
    "settings.skin": "تصميم الواجهة",
    "settings.skin.original": "الأصلي",
    "settings.skin.clinical": "محطة عمل سريرية",
    "settings.skin.aurora": "أورورا",
    "settings.skin.hint": "ثلاثة تصاميم للواجهة نفسها. كل زر واختصار ونتيجة متطابقة في الثلاثة - يتغيّر المظهر والترتيب فقط.",
